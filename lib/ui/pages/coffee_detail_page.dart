...
class _CoffeeDetailPageState extends State<CoffeeDetailPage> {
  ...
  void openWhatsapp({@required number, @required message}) async {
    ...
    await canLaunch(url)
        ? launch(url)
        : print('Using Whatsapp App For Next Payment');
  }
      ...
      content: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            SizedBox(width: 16),
            Expanded(
              child: Text('Using Whatsapp App For Next Payment',
    ...
    return Scaffold(
      body: Stack(
        children: [
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      fit: BoxFit.cover,
                      image: (widget.products['image'] != null &&
                                                                ...
                                                                CustomElevatedButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    Order
                                                                      ...
                                                                      totalPrice:
                                                                          numberRupiah.format(quantity *
                                                                              int.parse(widget.products['price'])),
                                                                      picture: widget
                                                                              .products[
                                                                          'image'],
                                                                      time: DateTime
                                                                    ...
                                                                    await canLaunch("whatsapp://send?phone=+989173126447&text=Email: ${userState.user.email} \n\n I want buy ${widget.products['name']} \n\n Quantity : ${quantity.toString()} \n\n Total Price : ${numberRupiah.format(quantity * int.parse(widget.products['price']))}")
                                                                        ? launch(
                                                                            "whatsapp://send?phone=+989173126447&text=Email:${userState.user.email} \n\n I want buy ${widget.products['name']} \n\n Quantity : ${quantity.toString()} \n\n Total Price : ${numberRupiah.format(quantity * int.parse(widget.products['price']))}")
                                                                        : showCustomSnackBar(
                                                                            context);
          ...
          //     ),
          //     Text(
          //       'Decsription: ${widget.products['description']}',
          ...
          //     ),
          //     Text(
          //       "Options: ${widget.products['option'].join(',')}",
          //       style: TextStyle(
          //           fontSize: 18, decoration: TextDecoration.underline),
          //     ),
          //     Text(
          //       "Ratings: ${widget.products['rating'].join(',')}",
          //       style: TextStyle(
          //           fontSize: 18, decoration: TextDecoration.underline),
          //     ),
          //     Column(
          ...
          //                         number: "989173126447",
          //                         message:
          //                             "I want buy this ${widget.products['name']} \n email : ${userState.user.email}");
          //                   },
