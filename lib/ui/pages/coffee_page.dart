    ...
    return ListView(children: [
      Column(children: [
        ...
        Container(
          ...
          //We will display a user photo, user name, user balance => take from a blocker
          child: BlocBuilder<UserBloc, UserState>(
            builder: (_, userState) {
              //If the datauser has been to the load, it will display
              if (userState is UserLoaded) {
                //When account_confirmation_page.dart only entrusts imageFileToUploads
                //So, if not null
                if (imageFileToUpload != null) {
                  //uploadImage with file imageFileToUpload.
                  //then This is its function when it's finished
                  //and will restore the uploadImage with a string change
                  uploadImage(imageFileToUpload).then((downloadURL) {
                    //So when it's finished, the imageFiletoUpload is made again.
                ...
                return Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text("Coffee Lips", style: blackFontStyle1),
                  ...
                  itemBuilder: (context, index) => GestureDetector(
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  CoffeeDetailPage(snapshot.data.docs[index])));
                    },
                    child: Padding(
                      ...
                      child: ProductCard(
                          ...
                          rating: snapshot.data.docs[index]['rating'].join(','),
